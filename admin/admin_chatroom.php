...
<body>
  <div class="container py-4 text-white">
    ...
    <div class="d-flex justify-content-between mb-4">
      ...
      <div class="align-items-center text-end pt-4">
        <a class="btn btn-outline-light border-2" style="margin-right: 15px;" role="button" href="/lumintu_qna/qna_display.php?id_session=<?php echo $id_sesi ?>">QnA Display</a>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      conn.onmessage = function(e) {
        ...
        $.ajax({
          url: 'http://192.168.18.67:8001/items/customer?fields=customer_id,customer_name&filter[customer_id]=' + data1.userId,
          type: 'GET',
  ...
  <script>
    ...
    $.ajax({
      url: 'http://192.168.18.67:8001/items/ticket?fields=ticket_id,ticket_type,ticket_x_session.session_id.*,ticket_x_day.day_id.*',
      type: 'GET',
      dataType: 'json',
      success: function(data, textStatus, xhr) {
        // data.data.map(item => {
