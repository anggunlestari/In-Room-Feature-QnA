                            ...
                            <form method="post" id="chat_form" data-parsley-errors-container="#validation_error">
                                <div class="row">
                                    <div class="col-11 pe-3">
                                        <textarea class="chat-text-area form-control border-0 me-3" id="chat_message" name="chat_message" rows="1" placeholder="Tulis pesan Anda..." style="background-color:#FFFFFF" required></textarea>
                                    </div>
