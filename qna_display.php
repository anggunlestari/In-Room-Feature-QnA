...
<body style="background-color: #ffffff;">
    ...
    <div class="container pb-5">
        <div class="mx-auto">
            <div id="logo" class="py-4 d-flex justify-content-center align-items-center">
        ...
        <div class="card border-0 shadow-lg" style="width: 100%;height: 100%;">
            ...
            <div class="card text white rounded-0 rounded-top" style="background-color: #38435F; 
            width: 100%;
            height: 100%; 
            border: 0px;">
            ...
            <div class="card text white shadow-lg border-0 rounded-0 rounded-bottom p-5" style="background-color: white; 
                width: 100%;">
...
<script>
    ...
    $.ajax({
        url: 'http://192.168.18.67:8001/items/ticket?fields=ticket_id,ticket_type,ticket_x_session.session_id.*,ticket_x_day.day_id.*&filter[ticket_id]=' + id_tiket,
        type: 'GET',
        dataType: 'json',
