...
$url = "http://192.168.18.67:8002/items/registration?fields=validated_on,id_participant,id_session&filter[id_session]=" . $sesi_id[1] . "&filter[id_participant]=" . $peserta_id[1];
$curl = curl_init();
...
$url_sesi = "http://192.168.18.67:8001/items/session?fields=session_id,start_time,finish_time&filter[session_id]=" . $sesi_id[1];
$curl = curl_init();
